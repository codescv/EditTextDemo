 ...
 */
@protocol ComposeTestViewControllerDelegate <NSObject>
 ...
 */
- (void)composeController:(ComposeTestViewController*)controller didSendFields:(NSArray*)fields;
 ...
 */
- (void)composeControllerWillCancel:(ComposeTestViewController*)controller;
 ...
 */
- (void)composeControllerShowRecipientPicker:(ComposeTestViewController*)controller;
